...
class Plugin_Protector {
	...
	private function __construct() {
		...
		// load activation notice to guide users to the next step
		add_action( 'admin_notices', array( $this, 'display_plugin_retirement_message' ) );
	 ...
	 * @since    1.2
	 */
	public function display_plugin_retirement_message() {
		...
		if ( 'plugins.php' == $pagenow ) {
			...
			$html = '<div class="error">';
				$html .= '<p style="display: inline-block">';
					$html .= __( '<strong>Alert!</strong> <code>Plugin Protector</code> may not protect your plugins, is no longer supported, and is due for retirement. For a suitable replacement, check out <code><a href="https://wordpress.org/plugins/lock-your-updates/">Lock Your Updates</a></code>.' );
				$html .= '</p>';
			$html .= '</div>';
	...
	} // end display_plugin_retirement_message
