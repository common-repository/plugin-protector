...
**Alert: Plugin Protector may not protect your plugins, is no longer supported, and is due for retirement. For a suitable replacement, check out [Lock Your Updates](https://wordpress.org/plugins/lock-your-updates/ "Lock Your Updates").**
